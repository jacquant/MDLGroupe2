          ...
          <v-widget title="Custom Icons">
            <div slot="widget-content">
              ...
              <v-alert
                ...
                :value="true"
                icon="message"
              >This is a warning alert with a custom icon.</v-alert>
              <v-alert
                color="info"
                icon="star"
                :value="true"
              >This is a info alert with a custom icon.</v-alert>
        ...
        <v-flex sm12 md6 sm6>
          <v-widget title="Outline Alerts">
            <div slot="widget-content">
              ...
              <v-alert outline color="info" icon="info" :value="true">This is an info alert.</v-alert>
              <v-alert
                outline
                color="warning"
                icon="priority_high"
                :value="true"
              >This is a warning alert.</v-alert>
              <v-alert outline color="error" icon="warning" :value="true">This is a error alert.</v-alert>
            </div>
          </v-widget>
        </v-flex>
        <v-flex sm12 md6 sm6>
          <v-widget title="Closable Alerts">
            <div slot="widget-content">
              ...
              >This is a success alert that is closable with scale transition.</v-alert>
              <v-alert
                type="error"
                dismissible
                v-model="alert.showError"
              >This is a error alert that is closable.</v-alert>
              <v-alert
                type="warning"
                dismissible
                v-model="alert.showWarnning"
              >This is a warning alert that is closable.</v-alert>
              <v-alert
                type="info"
                dismissible
                v-model="alert.showInfo"
              >This is a info alert that is closable.</v-alert>
