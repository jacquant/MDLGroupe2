                  ...
                  <v-card-text class="grey lighten-3">
                    <v-layout>
                      ...
                      <v-flex xs3 layout column>
                        ...
                        <div>
                          <v-icon size="18px" class="mr-3">fa-home</v-icon>New York, NY 10012, US
                        </div>
                        <div>
                          <v-icon size="18px" class="mr-3">fa-envelope</v-icon>info@example.com
                        </div>
                        <div>
                          <v-icon size="18px" class="mr-3">fa-phone</v-icon>+ 01 234 567 88
                        </div>
                        <div>
                          <v-icon size="18px" class="mr-3">fa-print</v-icon>+ 01 234 567 89
                        </div>
                      </v-flex>
                    </v-layout>
                  </v-card-text>
