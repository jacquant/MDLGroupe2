          ...
          <v-widget title="Custom Icons">
            <div slot="widget-content">
              ...
              <v-alert color="error" :value="true"
                >This is an error alert with no icon.</v-alert
              >
            </div>
          </v-widget>
        </v-flex>
          ...
          <v-widget title="Closable Alerts">
            <div slot="widget-content">
              <v-alert
                ...
                >This is a success alert that is closable with scale
                transition.</v-alert
              >
