                  ...
                  <v-layout align-center>
                    <v-flex>
                      ...
                      <span class="subheading">
                        ...
                        Vis maluisset molestiae id, ad semper lobortis cum. At
                        impetus detraxit incorrupte usu, repudiare assueverit ex
                        eum, ne nam essent vocent admodum.
                      </span>
        ...
        <v-flex lg6>
          <v-widget title="Gradient with image">
            <div slot="widget-content">
              ...
              <v-jumbotron src="/static/bg/16.jpg" :gradient="gradient2" dark>
                <v-container fill-height>
                  <v-layout align-center>
                    <v-flex text-xs-center>
