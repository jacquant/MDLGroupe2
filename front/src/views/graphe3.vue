...
<script>
import "./sigma.js-1.2.1/build/plugins/sigma.parsers.json.min.js";
import "./sigma.js-1.2.1/build/plugins/sigma.layout.forceAtlas2.min.js";
import "./sigma.js-1.2.1/build/plugins/sigma.layout.noverlap.min.js";
...
function displayGraph(content) {
  ...
  s.bind("overNode outNode clickNode doubleClickNode rightClickNode", function(
    e
  ) {
